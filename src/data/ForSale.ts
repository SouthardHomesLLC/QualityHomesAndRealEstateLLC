import { createPropertySlug, type ForSaleInfo } from "@data/HomeInfo";
...
export const homesForSale: ForSaleInfo[] = [
  ...
  },
  {
    ...
    features: ["Updated kitchen", "Fireplace", "Covered porch", "Storage shed"],
    status: "available",
...
export const featuredHomesForSale = homesForSale.filter(
  (home) => home.featured && home.status === "available",
);
